...
server.listen(process.env.port || process.env.PORT || 3978, () => {
    ...
    console.log(`\nTo talk to your bot, open qna-bot-v-4.bot file in the Emulator`);
});

// .bot file path
const BOT_FILE = path.join(__dirname, (process.env.botFilePath || ''));
// console.log(`\n**** ${ BOT_FILE }`);
const BOT_FILE2 = 'C:\\project\\azure_bots\\qna-bot-v-4\\qna-bot-v-4.bot';
// console.log(`\n----- ${ BOT_FILE2 }`);
...
try {
    ...
    botConfig = BotConfiguration.loadSync(BOT_FILE2, process.env.botFileSecret);
} catch (err) {
